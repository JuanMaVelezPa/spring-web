...
import com.jm.spring_web.entrypoints.rest.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleUnprocessable(RuntimeException exception, HttpServletRequest request) {
